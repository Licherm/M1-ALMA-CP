...
public class BackTrackingQueen2 {
	 ...
	 * @param Node2 = Node2 ou chacun des Domains est r√©duit √† une seule valeur
	 *  
	...
	public static void main(String[] args) {
		...
		int nbCase=5;// Les dimensions de l'Èchequier
		...
		System.out.println(backQ.backTrackingQueenPrune2(n)+" solutions trouvÈ");
